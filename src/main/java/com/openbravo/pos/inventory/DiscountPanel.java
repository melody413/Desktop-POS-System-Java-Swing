 ...
 * @author adrianromero
 */
public class DiscountPanel extends JPanelTable {
    ...
    protected void init() {
        ...
        jeditor = new DiscountEditor(app, dirty);
    }
    ...
    public Vectorer getVectorer() {
        return tdiscounts.getVectorerBasic(new int[]{1});
    }
    ...
    public ComparatorCreator getComparatorCreator() {
        return tdiscounts.getComparatorCreator(new int[] {1});
    }
