...
public class ProductInfoExt {
    ...
    protected boolean m_bDisableRegPrice;
    protected boolean m_bFastBar;
    ...
    protected String m_attSetInstId;
    protected String m_attSetInstDesc;
    protected List<Modifier> m_modifiers;
    protected double m_dPriceSellH;
    protected String m_sStationId;
    ...
    public final double getPriceSellH() {
        return m_dPriceSellH;
    }
    public final void setPriceSellH(double dPrice) {
        m_dPriceSellH = dPrice;
    }    
    ...
    public final boolean isDisableRegPrice() {
        return m_bDisableRegPrice;
    }

    public final boolean isFastBar() {
        return m_bFastBar;
    }
...
// Nam Ho Added
    public final String getAttSetInstId() {
        return m_attSetInstId;
    }
    public final void setAttSetInstId(String dAttSetInstId) {
        m_attSetInstId = dAttSetInstId;
    }   
    public final String getAttSetInstDesc() {
        return m_attSetInstDesc;
    }
    public final void setAttSetInstDesc(String dAttSetInstDesc) {
        m_attSetInstDesc = dAttSetInstDesc;
    }
    public final void setModifiers(List<Modifier> dModifiers){
        m_modifiers = dModifiers;
    }
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() {
            ...
            public Object readValues(DataRead dr) throws BasicException {
                ...
                product.m_bDisableRegPrice = dr.getBoolean(23);   
                product.m_bFastBar = dr.getBoolean(24);                      
                product.m_bVerpatrib = dr.getBoolean(25);                                       
                product.m_sTextTip = dr.getString(26);                          
                product.m_bWarranty = dr.getBoolean(27);                        
                product.m_dStockUnits = dr.getDouble(28); 
                product.m_sPrinter = dr.getString(29);
                product.supplierid = dr.getString(30);
                product.uomid = dr.getString(31);
                product.memodate = dr.getString(32);
                if(dr.getDouble(33) == null) product.m_dPriceSellH = 0.0;
                else product.m_dPriceSellH = dr.getDouble(33);
                product.m_sStationId = dr.getString(34);
                return product;
            }
        };
    }
