...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
  ...
  public JPrincipalApp(JRootApp appview, AppUser appuser) {
    ...
    String userRole = m_appuser.getRole();
    if("2".equals(userRole)||"3".equals(userRole)|| "4".equals(userRole)){
   ...
   */
    ...
    private void initComponents() {
        ...
        m_jPanelLeft.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jPanelContainer.setBackground(new java.awt.Color(204, 204, 204));
