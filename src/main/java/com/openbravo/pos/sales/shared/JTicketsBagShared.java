    ...
    */
    ...
    private void setActiveTicket(String id) throws BasicException{
        ...
        if (ticket == null)  {
            ...
            m_sCurrentTicket = id;
            m_panelticket.setActiveTicket(ticket, null, false);
    ...
    private void initComponents() {
        ...
        m_jNewTicket.setText("Open Ticket");
        ...
        m_jDelTicket.setText("Delete Ticket");
        ...
        m_jReprintTickets.setText("Reprint Ticket");
        ...
        SwingUtilities.invokeLater(() -> {
            try {
                if (!m_App.getAppUserView().getUser().hasPermission("sales.ViewSharedTicket")){
                    ...
                    {
                        List<SharedTicketInfo> l = dlReceipts.getSharedTicketList();
                        Window window = getWindow(JTicketsBagShared.this);
