...
import com.openbravo.pos.panels.ClosedTicketsModel;
 ...
 * @author JG uniCenta
 */
public class JTicketsBagClosedList extends javax.swing.JDialog {
    
    private String m_sDialogTicket;
    private AppView m_App;  
    private DataLogicSystem m_dlSystem;
    
    private ClosedTicketsModel m_ClosedTickets = null;   
    ...
    java.util.List<ClosedTicketsModel.PaymentsLine> paymentLines;
    ...
    private JTicketsBagClosedList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JTicketsBagSharedList */
    private JTicketsBagClosedList(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }
    ...
    private void loadData(int column) throws BasicException {
        ...
        // LoadData
        m_ClosedTickets = ClosedTicketsModel.loadInstance(m_App, openedTime, userid);
        paymentLines = m_ClosedTickets.getPaymentLines();
        
        if (m_ClosedTickets.getPayments() != 0 
                || m_ClosedTickets.getSales() != 0) {
        }

        m_jTicketTable.setModel(m_ClosedTickets.getPaymentsModel());

        m_jSelectRow.setText("  Re-Open");
    ...
    public class TableHeaderClickListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent event) {
            ...
            m_ClosedTickets.sortTableByColumn(column, sortDirection);
            sortColumn = column;
        }
    }
     ...
     * @return
     */
    public String showTicketsList(java.util.List<ClosedTicketInfo> atickets, DataLogicReceipts dlReceipts, AppView app) {
// JG Dec 2014
        m_App = app;
    ...
    public static JTicketsBagClosedList newJDialog(Window window) {        
        JTicketsBagClosedList mydialog;
        if (window instanceof Frame) { 
            mydialog = new JTicketsBagClosedList((Frame) window, true);
        } else {
            mydialog = new JTicketsBagClosedList((Dialog) window, true);
        } 
    ...
    private void initComponents() {
        ...
        m_jSelectRow.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/reload.png"))); // NOI18N
