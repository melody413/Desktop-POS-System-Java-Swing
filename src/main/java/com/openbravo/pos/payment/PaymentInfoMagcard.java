...
public class PaymentInfoMagcard extends PaymentInfo {
    ...
    public void setTip(double m_tip) {
        m_dTip = m_tip;
    }
...
//            return "****";
//        }
        return replaceWith(m_sCardNumber, m_sCardNumber.length() - 4);
    }

    public String replaceWith(String s, int replace) {
        int length = s.length();
