...
// end     
    ...
    private final static String[] TICKETHEADERS = {"label.tabname", "label.timeelapsed", "label.server", "label.total"};
     ...
     * @return
     */
    public static ClosedTicketsModel emptyInstance() {
        
        ClosedTicketsModel p = new ClosedTicketsModel();
...
// JG 16 May 2013 use diamond inference
     ...
     */
    public static ClosedTicketsModel loadInstance(AppView app, String openedTime, String userid) throws BasicException {
        ClosedTicketsModel p = new ClosedTicketsModel();
...
// JG 9 Nov 12
        ...
        List categorys = new StaticSentence(app.getSession()
            , "SELECT a.NAME, sum(c.UNITS), sum(c.UNITS * (c.PRICE + (c.PRICE * d.RATE))) " +
              ...
              "GROUP BY a.NAME"
            , SerializerWriteString.INSTANCE
            , new SerializerReadClass(ClosedTicketsModel.CategorySalesLine.class))
...
// end
        ...
        List l = new StaticSentence(app.getSession(),            
            "select closed.ticketname, closed.id, closed.openedat, people.name from closedtickets closed "
                + "left join people on closed.openedby = people.id where closed.openedat >= TIMESTAMP(?) and closed.openedby = ?;"
            ,new SerializerWriteBasic(Datas.STRING, Datas.STRING)
            , new SerializerReadClass(ClosedTicketsModel.PaymentsLine.class))
            .list(p.openedTime, p.userid);
        ...
        List<SalesLine> asales = new StaticSentence(app.getSession(),
                ...
                , SerializerWriteString.INSTANCE
                , new SerializerReadClass(ClosedTicketsModel.SalesLine.class))
                .list(app.getActiveCashIndex());
        ...
        List removedLines = new StaticSentence(app.getSession()
            ...
            , SerializerWriteString.INSTANCE
            , new SerializerReadClass(ClosedTicketsModel.RemovedProductLines.class)) //new SerializerReadBasic(new Datas[] {Datas.STRING, Datas.DOUBLE}))
...
*/
        ...
        List drawerOpenedLines = new StaticSentence(app.getSession()
            ...
            , SerializerWriteString.INSTANCE
            , new SerializerReadClass(ClosedTicketsModel.DrawerOpenedLines.class)) //new SerializerReadBasic(new Datas[] {Datas.STRING, Datas.DOUBLE}))
            .list(startDateFormatted);
        ...
        List products = new StaticSentence(app.getSession()
            ...
            , SerializerWriteString.INSTANCE
            , new SerializerReadClass(ClosedTicketsModel.ProductSalesLine.class))
            .list(app.getActiveCashIndex());
        ...
        return new AbstractTableModel() {
            ...
            public Object getValueAt(int row, int column) {
                ...
                switch (column) {
                    ...
                    case 1: return l.getTimeElapsed();
                    case 2: return l.getServer();
                    case 3: 
                        TicketInfo ticket2 = null;
                        try {
                            ticket2 = dlReceipts.getClosedTicket(l.getRealSeat());
            ...
            public int compare(PaymentsLine p1, PaymentsLine p2) {
                ...
                switch (columnIndex) {
                    ...
                    case 3:
                        ...
                        try {
                            ticket1 = dlReceipts.getClosedTicket(p1.getSeat());
                            ticket2 = dlReceipts.getClosedTicket(p2.getSeat());
                        } catch (BasicException e) {}
