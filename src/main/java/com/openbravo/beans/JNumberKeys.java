...
public class JNumberKeys extends javax.swing.JPanel {
    ...
    public JNumberKeys() {
        ...
        m_jTip.addActionListener(new MyKeyNumberListener('t'));        
    ...
    private void initComponents() {
        ...
        m_jTip = new javax.swing.JButton();
        ...
        m_jTip.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/tip.png"))); // NOI18N
        m_jTip.setFocusPainted(false);
        m_jTip.setFocusable(false);
        m_jTip.setMargin(new java.awt.Insets(8, 16, 8, 16));
        m_jTip.setPreferredSize(new java.awt.Dimension(42, 36));
        m_jTip.setRequestFocusEnabled(false);
        m_jTip.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jTipActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
    ...
    private void m_jTipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jTipActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_m_jTipActionPerformed
    ...
    private javax.swing.JButton m_jTip;
