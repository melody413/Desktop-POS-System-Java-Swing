...
import static com.openbravo.editor.EditorKeys.MODE_INTEGER_POSITIVE;
 ...
 */
@Slf4j
public class JSplitPop extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public JSplitPop(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        init();
    }
     ...
     * @param parent
     * @param modal */
    public JSplitPop(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        init();
    }
    ...
    private void init() {
        ...
        m_jnumber.reset();
        m_jnumber.setValueInteger(2);
        m_jnumber.activate();

        m_jKeys.setMode(EditorKeys.MODE_INTEGER_POSITIVE);
    ...
    public static Integer showEditNumber(Component parent, String title, String message, Icon icon) {
        ...
        if (window instanceof Frame) { 
            myMsg = new JSplitPop((Frame) window, true);
        } else {
            myMsg = new JSplitPop((Dialog) window, true);
        }
